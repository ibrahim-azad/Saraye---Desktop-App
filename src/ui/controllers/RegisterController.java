...
if ("SUCCESS".equals(result)) {
    ui.utils.AlertUtil.showSuccess("Registration Successful", "Please login with your credentials");
    ui.utils.NavigationUtil.navigateTo("login.fxml");
} else {
    ui.utils.AlertUtil.showError("Registration Failed", result);
}
