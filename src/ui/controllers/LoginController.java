...
public class LoginController {
    ...
    // Call AuthController (Ibrahim's business logic)
    controllers.AuthController authController = controllers.AuthController.getInstance();
    models.User user = authController.login(email, password);
    ...
    if (user != null) {
        ...
        if ("GUEST".equalsIgnoreCase(role)) {
            ui.utils.NavigationUtil.navigateTo("guest-dashboard.fxml");
        } else if ("HOST".equalsIgnoreCase(role)) {
            ui.utils.NavigationUtil.navigateTo("host-dashboard.fxml");
        } else if ("ADMIN".equalsIgnoreCase(role)) {
            ui.utils.NavigationUtil.navigateTo("admin-dashboard.fxml");
        }
    } else {
        // Login failed
